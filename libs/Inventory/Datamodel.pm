...
our $C_STOR_DEV_SYMMETRIXID             =    "symm_id";
our $C_STOR_DEV_SYMMETRIXLOGID          =    "symm_logic_id";
our $C_STOR_DEV_SYMMSTATE               =    "state";
our $C_STOR_DEV_MULTIPATH               =    "multipath";
our $C_STOR_HBA                         =    "hbas";
...
our $targetsMap = {
     ...
     "C_STOR_DEV_SYMMETRIXID"                =>   [$C_STOR, $C_STOR_DEV, undef, $C_STOR_DEV_SYMMETRIXID],
     "C_STOR_DEV_SYMMETRIXLOGID"             =>   [$C_STOR, $C_STOR_DEV, undef, $C_STOR_DEV_SYMMETRIXLOGID],
     "C_STOR_DEV_SYMMSTATE"                  =>   [$C_STOR, $C_STOR_DEV, undef, $C_STOR_DEV_SYMMSTATE],
     "C_STOR_DEV_MULTIPATH"                  =>   [$C_STOR, $C_STOR_DEV, undef, $C_STOR_DEV_MULTIPATH],
